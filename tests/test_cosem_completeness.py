...
COSEM_MODULES = [
    "dlms_cosem.cosem.C1_Data",
    "dlms_cosem.cosem.C2_Register",
    "dlms_cosem.cosem.C3_ExtendedRegister",
    "dlms_cosem.cosem.C4_DemandRegister",
    "dlms_cosem.cosem.C14_RegisterActivation",
    "dlms_cosem.cosem.C13_RegisterMonitor",
    "dlms_cosem.cosem.C61_RegisterTable",
    "dlms_cosem.cosem.C6_Clock",
    "dlms_cosem.cosem.C7_ScriptTable",
    "dlms_cosem.cosem.C9_ActionSchedule",
    "dlms_cosem.cosem.single_action_schedule",
    "dlms_cosem.cosem.C8_SpecialDayTable",
    "dlms_cosem.cosem.day_profile",
    "dlms_cosem.cosem.week_profile",
    "dlms_cosem.cosem.season_profile",
    "dlms_cosem.cosem.C5_ProfileGeneric",
    "dlms_cosem.cosem.C11_AssociationLN",
    "dlms_cosem.cosem.C10_AssociationSN",
    "dlms_cosem.cosem.current",
    "dlms_cosem.cosem.C29_SecuritySetup",
    "dlms_cosem.cosem.event_notification",
    "dlms_cosem.cosem.C76_EventLog",
    "dlms_cosem.cosem.standard_event_log",
    "dlms_cosem.cosem.utility_event_log",
    "dlms_cosem.cosem.C102_LocalPortSetup",
    "dlms_cosem.cosem.C101_InfraredSetup",
    "dlms_cosem.cosem.C90_LoadProfileSwitch",
    "dlms_cosem.cosem.C28_AutoAnswer",
    "dlms_cosem.cosem.C24_ModemSetup",
    "dlms_cosem.cosem.C48_ModemConfiguration",
    "dlms_cosem.cosem.gprs_setup",
    "dlms_cosem.cosem.C107_LoRaWANSetup",
    "dlms_cosem.cosem.C106_NBIoTProfileSetup",
    "dlms_cosem.cosem.C39_TcpUdpSetup",
    "dlms_cosem.cosem.C46_ZigBeeSetup",
    "dlms_cosem.cosem.C23_RS485Setup",
    "dlms_cosem.cosem.current",
    ...
    "dlms_cosem.cosem.C205_MaxDemandRegister",
