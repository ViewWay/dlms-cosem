...
COSEM_MODULES = [
    ...
    "dlms_cosem.cosem.C3_Register",
    "dlms_cosem.cosem.C4_ExtendedRegister",
    "dlms_cosem.cosem.C5_DemandRegister",
    "dlms_cosem.cosem.C6_RegisterActivation",
    "dlms_cosem.cosem.C21_RegisterMonitor",
    "dlms_cosem.cosem.C61_RegisterTable",
    "dlms_cosem.cosem.C8_Clock",
    "dlms_cosem.cosem.C9_ScriptTable",
    "dlms_cosem.cosem.C10_Schedule",
    "dlms_cosem.cosem.C22_SingleActionSchedule",
    "dlms_cosem.cosem.C11_SpecialDaysTable",
    "dlms_cosem.cosem.day_profile",
    "dlms_cosem.cosem.week_profile",
    "dlms_cosem.cosem.season_profile",
    "dlms_cosem.cosem.C7_ProfileGeneric",
    "dlms_cosem.cosem.C15_AssociationLN",
    "dlms_cosem.cosem.C12_AssociationSN",
    "dlms_cosem.cosem.current",
    "dlms_cosem.cosem.C64_SecuritySetup",
