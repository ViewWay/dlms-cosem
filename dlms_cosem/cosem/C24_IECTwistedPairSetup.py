...
class InfraredSetup:
    ...
    def to_bytes(self) -> bytes:
        ...
        # Attribute 3: baudrate (integer)
        result += self._encode_integer(self.baudrate)
        # Attribute 4: parity (integer)
        result += self._encode_integer(self.parity)
        # Attribute 5: stop_bits (integer)
        result += self._encode_integer(self.stop_bits)
        # Attribute 6: data_bits (integer)
        result += self._encode_integer(self.data_bits)
        # Attribute 7: protocol_type (integer)
        result += self._encode_integer(self.protocol_type)
        return bytes(result)
    @classmethod
    def from_bytes(cls, data: bytes) -> 'InfraredSetup':
