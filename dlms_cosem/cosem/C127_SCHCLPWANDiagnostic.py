"""IC class 127 - SCHCLPWANDiagnostic.

SCHC LPWAN Diagnostic - SCHC LPWAN diagnostics.

Blue Book: DLMS UA 1000-1 Ed. 16, class_id=127
"""
...
class SCHCLPWANDiagnostic:
    """COSEM IC SCHCLPWANDiagnostic (class_id=127).
    ...
    CLASS_ID: ClassVar[int] = enums.CosemInterface.SCHC_LPWAN_DIAGNOSTICS
    ...
    def to_bytes(self) -> bytes:
        ...
        return bytes(result)
    @classmethod
    def from_bytes(cls, data: bytes) -> 'SCHCLPWANDiagnostic':
